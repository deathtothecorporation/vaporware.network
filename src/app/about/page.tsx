    ...
    <div>
      <main id="vision" className="mt-24 content-zone mx-auto px-4 mb-12">
        <div>
          ...
          <p>
Software is the best tool we have to solve societal issues at scale, so why does modern software seem to cause so much harm and conflict? We believe the root cause is the siloing of software into applications and the economic relationships it incentives.
          </p>
